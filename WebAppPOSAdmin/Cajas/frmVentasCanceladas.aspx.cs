...
namespace WebAppPOSAdmin.Cajas
{
    public partial class frmVentasCanceladas : System.Web.UI.Page
    {
        ...
        {
            List<VentaCanceladaExtended> list = null;
            try
            {
                ...
                Session["SalesCancel"] = null;
                if (!ddlCaja.SelectedValue.Equals("0") && !ddlSupervisor.SelectedValue.Equals("") && !ddlCajero.SelectedValue.Equals(""))
                {
                    Session["caja"] = ddlCaja.SelectedValue;
                    Session["cajero"] = ddlCajero.SelectedValue;
                    Session["supervisor"] = ddlSupervisor.SelectedValue;
                    Session["SalesCancel"] = new RepositorioCajas().getVentasCanceladas(dateTime, dateTime2, int.Parse(ddlCaja.SelectedValue), ddlCajero.SelectedValue, ddlSupervisor.SelectedValue);
                }
                else if (!ddlCaja.SelectedValue.Equals("0") && !ddlCajero.SelectedValue.Equals(""))
                {
                    Session["caja"] = ddlCaja.SelectedValue;
                    Session["cajero"] = ddlCajero.SelectedValue;
                    Session["supervisor"] = null;
                    Session["SalesCancel"] = new RepositorioCajas().getVentasCanceladas(dateTime, dateTime2, int.Parse(ddlCaja.SelectedValue), ddlCajero.SelectedValue);
                }
                else if (!ddlCaja.SelectedValue.Equals("0") && !ddlSupervisor.SelectedValue.Equals(""))
                {
                    Session["caja"] = ddlCaja.SelectedValue;
                    Session["cajero"] = null;
                    Session["supervisor"] = ddlSupervisor.SelectedValue;
                    Session["SalesCancel"] = new RepositorioCajas().getVentasCanceladas(ddlSupervisor.SelectedValue, dateTime, dateTime2, int.Parse(ddlCaja.SelectedValue));
                }
                else if (!ddlCaja.SelectedValue.Equals("0"))
                {
                    ...
                    Session["cajero"] = null;
                    Session["supervisor"] = null;
                    Session["SalesCancel"] = new RepositorioCajas().getVentasCanceladas(dateTime, dateTime2, int.Parse(ddlCaja.SelectedValue));
                }
                else if (!ddlSupervisor.SelectedValue.Equals("") && !ddlCajero.SelectedValue.Equals(""))
                {
                    Session["caja"] = null;
                    Session["cajero"] = ddlCajero.SelectedValue;
                    Session["supervisor"] = ddlSupervisor.SelectedValue;
                    Session["SalesCancel"] = new RepositorioCajas().getVentasCanceladas(dateTime, dateTime2, ddlCajero.SelectedValue, ddlSupervisor.SelectedValue);
                }
                else if (!ddlCajero.SelectedValue.Equals(""))
                {
                    ...
                    Session["cajero"] = ddlCajero.SelectedValue;
                    Session["supervisor"] = null;
                    Session["SalesCancel"] = new RepositorioCajas().getVentasCanceladas(dateTime, dateTime2, ddlCajero.SelectedValue);
                }
                else if (!ddlSupervisor.SelectedValue.Equals(""))
                {
                    Session["caja"] = null;
                    Session["cajero"] = null;
                    Session["supervisor"] = ddlSupervisor.SelectedValue;
                    Session["SalesCancel"] = new RepositorioCajas().getVentasCanceladas(ddlSupervisor.SelectedValue, dateTime, dateTime2);
                }
                else
                {
                    Session["caja"] = null;
                    Session["cajero"] = null;
                    Session["supervisor"] = null;
                    Session["SalesCancel"] = new RepositorioCajas().getVentasCanceladas(dateTime, dateTime2);
                }
                list = (List<VentaCanceladaExtended>)Session["SalesCancel"];
                if (list.Count == 0)
                {
        ...
        protected void btnExportarPdf_Click(object sender, EventArgs e)
        {
            try
            {
                string arg = "http://" + base.Request["HTTP_HOST"] + "/PdfReports/VentaCancelada.aspx";
        ...
        protected void btnExportarExcel_Click(object sender, EventArgs e)
        {
            try
            {
                string arg = "http://" + base.Request["HTTP_HOST"] + "/DocsXLS/VentaCancelada.aspx";
                string script = $"window.open('{arg}', '_blank', 'toolbar=no,scrollbars=no,resizable=yes,top=0,left=0,width=800,height=600');";
                ScriptManager.RegisterStartupScript(this, GetType(), "modal", script, addScriptTags: true);
            }
            catch (Exception ex)
