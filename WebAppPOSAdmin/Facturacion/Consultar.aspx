<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="Consultar.aspx.cs" Inherits="WebAppPOSAdmin.Facturacion.Consultar" %>
    ...
    <div class="panel panel-primary quitar-margin">
        <div class="panel-heading">
            <div class="panel-title">
                <h4><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp; Visor de Facturaci&oacute;n</h4>
            </div>
        </div>
        <div class="panel-body">
            ...
            <div class="row col-lg-8 col-lg-offset-2">
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvFacturaciones" runat="server" AutoGenerateColumns="False" CssClass="table table-striped" OnRowCommand="gvCancelaciones_RowCommand">
                            <Columns>
                                ...
                                <asp:BoundField DataField="fecha_suspencion" HeaderText="Fecha" ReadOnly="True" SortExpression="fecha_suspencion" ItemStyle-HorizontalAlign="Center" />
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Detalle de Venta Suspendida</h4>
                        </div>
